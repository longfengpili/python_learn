...
文件地址： `c:\Users\HQ\.jupyter\jupyter_lab_config.py`  

```shell
c = get_config()  #noqa
c.ServerApp.notebook_dir = r'D:\SynologyDrive\Sincetimes'
```

3. ipython配置

文件地址： `c:\Users\HQ\.ipython\profile_default\ipython_config.py`  
